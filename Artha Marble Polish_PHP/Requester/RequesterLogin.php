...
<div class="mb-3 text-center mt-5" style="font-size: 30px;">
    <i class="fas fa-square" style="color: teal;"></i>
    <span>Artha Marble Polish</span>
</div>


  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-user-secret text-danger"></i> <span>login
      Area</span>
  </p>
